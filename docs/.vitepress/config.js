export default {
  ...
  head: [
    ['link', { rel: "apple-touch-icon", sizes: "180x180", href: "/sep-api/apple-touch-icon.png"}],
    ['link', { rel: "icon", type: "image/png", sizes: "32x32", href: "/sep-api/favicon-32x32.png"}],
    ['link', { rel: "icon", type: "image/png", sizes: "16x16", href: "/sep-api/favicon-16x16.png"}],
